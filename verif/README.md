...
* tests/: This directory contains the complete, self-contained testbenches for each specific DUT in the rtl/ directory.  
  ...
  * **Contents**: Each subdirectory (e.g., fp\_add/) contains all the necessary components for a testbench, including a DUT-specific transaction, driver, monitor, sequences, and environment, many of which extend the base classes found in lib/.
